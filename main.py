...
def get_args_parser():
    ...
    parser.add_argument('--model',type=str,default='[pretrain]',
                         choices=['pretrain','selection','retrain',],help='mode for train')
    ...
    parser.add_argument('--save_ckpt_num', default=60, type=int)
...
def main(args):
    ...
    # dataset_train, dataset_val = tts(dataset,test_size=0.2)
